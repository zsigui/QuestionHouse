package com.jackiez.questionhouse.utils.chiper;
...
public final class MD5 {
    ...
    public static byte[] genDigest(String content) {
        return genDigest(content, "UTF-8");
    }
    ...
    public static String digestInHex(byte[] content) {
        return Utils.bytesToHex(genDigest(content));
    }
    ...
    public static String digestInHex(String content, String charset) {
        return Utils.bytesToHex(genDigest(content, charset));
    }
